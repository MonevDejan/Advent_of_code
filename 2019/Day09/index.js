...
function processOpcode(puzzleString, inputSignal) {
    ...
    for (let i = 0; i < inputArray.length - 1; i) {
        ...
        const instruction = Number(inputArray[i]);
        ...
        switch (opcode) {
            ...
            case 4: {
                values.push(inputArray[indexes[0]]);
                i += parameterCount[opcode] + 1;
                break;
            }
            case 5: {
...
processOpcode(inputString, [1]);
processOpcode(inputString, [2]);
